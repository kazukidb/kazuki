...
//
//import io.kazuki.v0.internal.v1schema.validator.ReferenceValidator;
//import io.kazuki.v0.internal.v1schema.validator.ValidationException;
//import io.kazuki.v0.internal.v1schema.validator.ValidatorTransformer;
//
...
//
///**
// * Initial implementation of schema validation and transformation for KV storage.
// */
//public class SchemaValidatorTransformer
//    implements
...
//
//  public <T> SchemaValidatorTransformer(SchemaDefinition<T> schemaDefinition) {
...
//
//    newAttributesByName.put("id", new Attribute("id", AttributeType.REFERENCE, null, null, null,
//        Boolean.TRUE));
//
...
//    }
//
//    this.attributesByName = Collections.unmodifiableMap(newAttributesByName);
//
//    Map<String, ValidatorTransformer<?, ?>> newAttributeValidators =
//        new LinkedHashMap<String, ValidatorTransformer<?, ?>>();
//
//    newAttributeValidators.put("id", new ReferenceValidator("id"));
//
//    for (Attribute attribute : schemaDefinition.getAttributes()) {
//      newAttributeValidators.put(attribute.getName(), validators.validatorFor(attribute));
//    }
//
//    this.attributeValidators = Collections.unmodifiableMap(newAttributeValidators);
//  }
//
//  @Override
...
//    }
//
//    System.out.println("ORIG: " + instance);
//
//    Map<String, Object> mindlessClone = new LinkedHashMap<String, Object>();
//
//    for (Map.Entry<String, ValidatorTransformer<?, ?>> e : attributeValidators.entrySet()) {
...
//        }
//
//        throw new ValidationException("attribute must not be null: " + attrName);
//      }
//
//      try {
...
//        throw new ValidationException("invalid attribute value for '" + attrName + "'");
//      }
//    }
//
...
//    }
//
//    System.out.println("XFORM: " + mindlessCloneInOrder);
//
//    return mindlessCloneInOrder;
//  }
//
//  @Override
//  public Map<String, Object> untransform(Map<String, Object> instance) throws ValidationException {
//    if (instance == null) {
//      throw new ValidationException("instance must not be null");
//    }
//
...
//  }
//
//  public Object transformValue(String attrName, Object value) throws ValidationException {
//    try {
//      ValidatorTransformer validator = attributeValidators.get(attrName);
//
